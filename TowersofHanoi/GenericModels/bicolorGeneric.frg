...
// RUN STATEMENTS
// Minimum moves: 1
// run {Btrace} for exactly 1 BRing, 3 BTower
// Minimum moves: 3#lang forge/temporal
...
// Minimum moves: 5
// run {Btrace} for exactly 3 BRing, 4 BTower
// Minimum moves: 9
// run {Btrace} for exactly 4 BRing, 4 BTower, 5 Int
